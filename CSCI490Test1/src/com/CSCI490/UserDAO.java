...
/**
 * UserDAO is an interface that defines all the actions which needs to be performed on the User model class to control the database
 * E.G. createUser, findUser, changePassword...
 * 
 * 
 * All methods which returns the {@link User} from the DB, will not
